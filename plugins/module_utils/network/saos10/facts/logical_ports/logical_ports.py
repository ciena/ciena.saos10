...
"""
The saos10 logical-ports fact class
...
class LogicalPortsFacts(object):
    """The saos10 logical-ports fact class"""

    def __init__(self, module, subspec="config", options="options"):
        self._module = module
        self.argument_spec = LogicalPortsArgs.argument_spec
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        """Populate the facts for logical-ports
        ...
        resources = data.xpath("/rpc-reply/data/logical-ports/logical-ports")
        objs = []
        ...
        if objs:
            ...
            for cfg in params["config"]:
                facts["logical-ports"].append(utils.remove_empties(cfg))
