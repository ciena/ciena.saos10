...
class IsisFacts(object):
    """The saos10 isis fact class"""

    def __init__(self, module, subspec="config", options="options"):
        self._module = module
        self.argument_spec = IsisArgs.argument_spec
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        if objs:
            ...
            for cfg in params["config"]:
                facts["isis"].append(utils.remove_empties(cfg))
